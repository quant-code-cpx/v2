...
class SectorDailyBar(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_sector_daily_bar_current_read",
            "sector_key",
            desc("period_end"),
            postgresql_include=[
                "open_price",
        ...
        {"comment": "上游直接板块日线 revision；当前行由 valid_to 为空表示。"},
    )
    ...
    period_end: Mapped[date] = mapped_column(
        Date, primary_key=True, nullable=False, comment="日线周期结束交易日。"
    )
