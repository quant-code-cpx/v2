...
class SectorMonthlyBar(Base):
    ...
    __table_args__ = (
        ...
        Index(
            "ix_sector_monthly_bar_current_read",
            "sector_key",
            desc("period_end"),
            postgresql_include=[
                "open_price",
        ...
        {"comment": "上游直接板块月线 revision；当前行由 valid_to 为空表示。"},
    )
    ...
    period_end: Mapped[date] = mapped_column(
        Date, primary_key=True, nullable=False, comment="月线周期结束交易日。"
    )
